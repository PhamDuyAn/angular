...
public class StaffOnProjectsController {
	...
	public ResponseEntity<?> getStaffOnProjects(@PathVariable("id") UUID id) {
	...
	public ResponseEntity<?> updateStaffOnProjects(@PathVariable("id") UUID id,
	...
	public ResponseEntity<?> deleteStaffOnProjects(@PathVariable("id") UUID id) {
